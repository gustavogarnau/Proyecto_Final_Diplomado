...
const Home = ({ onLogout }) => {
    return (
        <div className="container content_principal flex w-full h-screen">
            {/* Sidebar */}
            <Sidebar onLogout={onLogout} className="w-64 fixed h-full" />

            {/* Main Content */}
            <div className="content_card flex-1 ml-64 max-[768px]:ml-0 max-[768px]:p-1  p-6 max-[768px]:w-full">
